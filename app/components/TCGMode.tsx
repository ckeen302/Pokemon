...
export default function TCGMode() {
  ...
  const CardDisplay = ({ card }: { card: TCGCard }) => {
    ...
    if (viewMode === "list") {
      return (
        <Card
          className="modern-card hover:shadow-medium transition-all duration-200 cursor-pointer"
    ...
    return (
      <Card
        className="modern-card hover:shadow-medium transition-all duration-200 cursor-pointer h-full"
        onClick={() => setSelectedCard(card)}
      >
